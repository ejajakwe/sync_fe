...
export default function GameFormModal({ onSubmit, onClose, initialData }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#1a1a1a] border-gray-700 p-6 rounded w-full max-w-md text-white space-y-4">
        <h2 className="text-xl font-bold">{initialData ? "🛠️Edit" : "🛠️Tambah"} Game</h2>
        <div>
          <h3 className="text-sm font-semibold mb-2">Nama Game</h3>
          <Input
        ...
        <div>
          <h3 className="text-sm font-semibold mb-2">Logo Game</h3>
          <Input
            type="file"
            accept="image/*"
